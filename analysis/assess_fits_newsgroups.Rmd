...
Topic 1 appears to capture "off-topic" discussion:

```{r top-words, fig.width=3, fig.height=3}
...
ggsave("../plots/factors_scatterplot_newsgroups.eps",p4,height = 4,
       width = 4.25)
```
