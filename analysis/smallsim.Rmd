...
Although the SCD progresses very rapidly toward a solution, the EM
also recovers the same solution after a reasonable number of
iterations. In the next example, we will see that the EM updates fail
