...
fit1 <- fit_poisson_nmf(X,fit0=fit0,numiter=150,method="em",control=control)
fit2 <- fit_poisson_nmf(X,fit0=fit0,numiter=150,method="scd",control=control)
...
TO DO: Run LDA on this same data set.
